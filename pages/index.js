  ...
  return (
    <div className="p-4 max-w-md mx-auto">
      ...
      <div className="flex justify-center mb-4">
        <img src="https://i.imgur.com/eo4dM1f.png" alt="BTJ AQUA" className="w-32" />
      </div>

      <h1 className="text-xl font-bold mb-4 text-center">Ficha Contagem Estoque Ração</h1>

      <div ref={fichaRef} className="bg-white p-4 rounded-lg shadow">
              ...
              {[...Array(carretao === "carretao2" ? 6 : 8)].map((_, i) => (
                <div key={i} className="flex items-center space-x-1">
                  ...
                  <input
                    ...
                    className="border p-1 w-20 text-gray-500 text-sm"
                  />
                  <input
                    type="number"
                    placeholder="Kg"
                    ...
                    className="border p-1 w-14 text-gray-500 text-sm"
                  />
                </div>
              ))}
            </div>
      ...
      {/* BOTÕES CORRIGIDOS */}
      <button onClick={handleExport} className="mt-4 w-full border p-2 bg-blue-500 text-white rounded">
        Exportar como Imagem
      </button>
      <button onClick={handleShare} className="mt-2 w-full border p-2 bg-green-500 text-white rounded">
        Compartilhar
      </button>

      {/* PEIXE E FRASE FINAL (Corrigido) */}
      <div className="text-center mt-6">
        <img src="https://i.imgur.com/Z9zQpcJ.png" alt="Peixe BTJ" className="mx-auto w-16" />
